        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white/5 rounded-2xl p-4 border border-white/10 group hover:bg-white/10 transition-colors">
              ...
              <p className="text-lg font-black text-white">+€{monthlyIncome.toLocaleString()}</p>
            ...
            <div className="bg-white/5 rounded-2xl p-4 border border-white/10 group hover:bg-white/10 transition-colors">
              ...
              <p className="text-lg font-black text-white">-€{monthlyExpense.toLocaleString()}</p>
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex bg-slate-100 dark:bg-slate-800 p-1 rounded-xl">
             <button 
              ...
              className={`px-4 py-1.5 rounded-lg text-[9px] font-black uppercase transition-all ${viewType === 'income' ? 'bg-emerald-500 text-white shadow-md' : 'text-slate-400'}`}
             >Income</button>
             <button 
              onClick={() => setViewType('expense')}
              className={`px-4 py-1.5 rounded-lg text-[9px] font-black uppercase transition-all ${viewType === 'expense' ? 'bg-rose-500 text-white shadow-md' : 'text-slate-400'}`}
             >Expense</button>
          </div>
        </div>
